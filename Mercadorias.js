...
var secaoDouwesen = document.getElementById('secaoDouwesen');
var secaoFalaiseDeFleur = document.getElementById('secaoFalaiseDeFleur');
var secaoIslaMuelle = document.getElementById('secaoIslaMuelle');
var secaoOxbay = document.getElementById('secaoOxbay');
var secaoRedmond = document.getElementById('secaoRedmond');
...
var diferencaDePreco = document.getElementById('diferencaDePreco');
var lucro = document.getElementById('lucro');

var produtoMaisBarato = document.getElementById('produtoMaisBarato');
var produtoMaisCaro = document.getElementById('produtoMaisCaro');
var produtosMaisBaratosComprar = document.getElementById('produtosMaisBaratosComprar');
var produtosMaisCarosVender = document.getElementById('produtosMaisCarosVender');
var cidadeComMelhoresPrecos = document.getElementById('cidadeComMelhoresPrecos');
var cidadeParaMelhoresCompras = document.getElementById('cidadeParaMelhoresCompras');

//

var resultadoCerveja = document.getElementById('resultadoCerveja');
...
var compraCervejaConceicao = document.getElementById('compraCervejaConceicao');
var vendaCervejaConceicao = document.getElementById('vendaCervejaConceicao');

var compraChocolateConceicao = document.getElementById('compraChocolateConceicao');
var vendaChocolateConceicao = document.getElementById('vendaChocolateConceicao');

var compraCanelaConceicao = document.getElementById('compraCanelaConceicao');
var vendaCanelaConceicao = document.getElementById('vendaCanelaConceicao');

var compraRoupasConceicao = document.getElementById('compraRoupasConceicao');
var vendaRoupasConceicao = document.getElementById('vendaRoupasConceicao');

var compraCafeConceicao = document.getElementById('compraCafeConceicao');
var vendaCafeConceicao = document.getElementById('vendaCafeConceicao');

var compraAlgodaoConceicao = document.getElementById('compraAlgodaoConceicao');
var vendaAlgodaoConceicao = document.getElementById('vendaAlgodaoConceicao');

var compraEbanoConceicao = document.getElementById('compraEbanoConceicao');
var vendaEbanoConceicao = document.getElementById('vendaEbanoConceicao');

var compraFrutasConceicao = document.getElementById('compraFrutasConceicao');
var vendaFrutasConceicao = document.getElementById('vendaFrutasConceicao');

var compraCouroConceicao = document.getElementById('compraCouroConceicao');
var vendaCouroConceicao = document.getElementById('vendaCouroConceicao');

var compraLinhoConceicao = document.getElementById('compraLinhoConceicao');
var vendaLinhoConceicao = document.getElementById('vendaLinhoConceicao');

var compraMognoConceicao = document.getElementById('compraMognoConceicao');
var vendaMognoConceicao = document.getElementById('vendaMognoConceicao');

var compraOleoConceicao = document.getElementById('compraOleoConceicao');
var vendaOleoConceicao = document.getElementById('vendaOleoConceicao');

var compraPapricaConceicao = document.getElementById('compraPapricaConceicao');
var vendaPapricaConceicao = document.getElementById('vendaPapricaConceicao');

var compraTabuasConceicao = document.getElementById('compraTabuasConceicao');
var vendaTabuasConceicao = document.getElementById('vendaTabuasConceicao');

var compraRumConceicao = document.getElementById('compraRumConceicao');
var vendaRumConceicao = document.getElementById('vendaRumConceicao');
...
var compraAcucarConceicao = document.getElementById('compraAcucarConceicao');
var vendaAcucarConceicao = document.getElementById('vendaAcucarConceicao');

var compraTabacoConceicao = document.getElementById('compraTabacoConceicao');
var vendaTabacoConceicao = document.getElementById('vendaTabacoConceicao');

var compraTrigoConceicao = document.getElementById('compraTrigoConceicao');
var vendaTrigoConceicao = document.getElementById('vendaTrigoConceicao');

var compraVinhoConceicao = document.getElementById('compraVinhoConceicao');
var vendaVinhoConceicao = document.getElementById('vendaVinhoConceicao');

////Douwesen:

var compraCervejaDouwesen = document.getElementById('compraCervejaDouwesen');
var vendaCervejaDouwesen = document.getElementById('vendaCervejaDouwesen');

var compraChocolateDouwesen = document.getElementById('compraChocolateDouwesen');
var vendaChocolateDouwesen = document.getElementById('vendaChocolateDouwesen');

var compraCanelaDouwesen = document.getElementById('compraCanelaDouwesen');
var vendaCanelaDouwesen = document.getElementById('vendaCanelaDouwesen');

var compraRoupasDouwesen = document.getElementById('compraRoupasDouwesen');
var vendaRoupasDouwesen = document.getElementById('vendaRoupasDouwesen');

var compraCafeDouwesen = document.getElementById('compraCafeDouwesen');
var vendaCafeDouwesen = document.getElementById('vendaCafeDouwesen');

var compraAlgodaoDouwesen = document.getElementById('compraAlgodaoDouwesen');
var vendaAlgodaoDouwesen = document.getElementById('vendaAlgodaoDouwesen');

var compraEbanoDouwesen = document.getElementById('compraEbanoDouwesen');
var vendaEbanoDouwesen = document.getElementById('vendaEbanoDouwesen');

var compraFrutasDouwesen = document.getElementById('compraFrutasDouwesen');
var vendaFrutasDouwesen = document.getElementById('vendaFrutasDouwesen');

var compraCouroDouwesen = document.getElementById('compraCouroDouwesen');
var vendaCouroDouwesen = document.getElementById('vendaCouroDouwesen');

var compraLinhoDouwesen = document.getElementById('compraLinhoDouwesen');
var vendaLinhoDouwesen = document.getElementById('vendaLinhoDouwesen');

var compraMognoDouwesen = document.getElementById('compraMognoDouwesen');
var vendaMognoDouwesen = document.getElementById('vendaMognoDouwesen');

var compraOleoDouwesen = document.getElementById('compraOleoDouwesen');
var vendaOleoDouwesen = document.getElementById('vendaOleoDouwesen');

var compraPapricaDouwesen = document.getElementById('compraPapricaDouwesen');
var vendaPapricaDouwesen = document.getElementById('vendaPapricaDouwesen');

var compraTabuasDouwesen = document.getElementById('compraTabuasDouwesen');
var vendaTabuasDouwesen = document.getElementById('vendaTabuasDouwesen');

var compraRumDouwesen = document.getElementById('compraRumDouwesen');
var vendaRumDouwesen = document.getElementById('vendaRumDouwesen');
...
var compraAcucarDouwesen = document.getElementById('compraAcucarDouwesen');
var vendaAcucarDouwesen = document.getElementById('vendaAcucarDouwesen');

var compraTabacoDouwesen = document.getElementById('compraTabacoDouwesen');
var vendaTabacoDouwesen = document.getElementById('vendaTabacoDouwesen');

var compraTrigoDouwesen = document.getElementById('compraTrigoDouwesen');
var vendaTrigoDouwesen = document.getElementById('vendaTrigoDouwesen');

var compraVinhoDouwesen = document.getElementById('compraVinhoDouwesen');
var vendaVinhoDouwesen = document.getElementById('vendaVinhoDouwesen');

////FalaiseDeFleur:

var compraCervejaFalaiseDeFleur = document.getElementById('compraCervejaFalaiseDeFleur');
var vendaCervejaFalaiseDeFleur = document.getElementById('vendaCervejaFalaiseDeFleur');

var compraChocolateFalaiseDeFleur = document.getElementById('compraChocolateFalaiseDeFleur');
var vendaChocolateFalaiseDeFleur = document.getElementById('vendaChocolateFalaiseDeFleur');

var compraCanelaFalaiseDeFleur = document.getElementById('compraCanelaFalaiseDeFleur');
var vendaCanelaFalaiseDeFleur = document.getElementById('vendaCanelaFalaiseDeFleur');

var compraRoupasFalaiseDeFleur = document.getElementById('compraRoupasFalaiseDeFleur');
var vendaRoupasFalaiseDeFleur = document.getElementById('vendaRoupasFalaiseDeFleur');

var compraCafeFalaiseDeFleur = document.getElementById('compraCafeFalaiseDeFleur');
var vendaCafeFalaiseDeFleur = document.getElementById('vendaCafeFalaiseDeFleur');

var compraAlgodaoFalaiseDeFleur = document.getElementById('compraAlgodaoFalaiseDeFleur');
var vendaAlgodaoFalaiseDeFleur = document.getElementById('vendaAlgodaoFalaiseDeFleur');

var compraEbanoFalaiseDeFleur = document.getElementById('compraEbanoFalaiseDeFleur');
var vendaEbanoFalaiseDeFleur = document.getElementById('vendaEbanoFalaiseDeFleur');

var compraFrutasFalaiseDeFleur = document.getElementById('compraFrutasFalaiseDeFleur');
var vendaFrutasFalaiseDeFleur = document.getElementById('vendaFrutasFalaiseDeFleur');

var compraCouroFalaiseDeFleur = document.getElementById('compraCouroFalaiseDeFleur');
var vendaCouroFalaiseDeFleur = document.getElementById('vendaCouroFalaiseDeFleur');

var compraLinhoFalaiseDeFleur = document.getElementById('compraLinhoFalaiseDeFleur');
var vendaLinhoFalaiseDeFleur = document.getElementById('vendaLinhoFalaiseDeFleur');

var compraMognoFalaiseDeFleur = document.getElementById('compraMognoFalaiseDeFleur');
var vendaMognoFalaiseDeFleur = document.getElementById('vendaMognoFalaiseDeFleur');

var compraOleoFalaiseDeFleur = document.getElementById('compraOleoFalaiseDeFleur');
var vendaOleoFalaiseDeFleur = document.getElementById('vendaOleoFalaiseDeFleur');

var compraPapricaFalaiseDeFleur = document.getElementById('compraPapricaFalaiseDeFleur');
var vendaPapricaFalaiseDeFleur = document.getElementById('vendaPapricaFalaiseDeFleur');

var compraTabuasFalaiseDeFleur = document.getElementById('compraTabuasFalaiseDeFleur');
var vendaTabuasFalaiseDeFleur = document.getElementById('vendaTabuasFalaiseDeFleur');

var compraRumFalaiseDeFleur = document.getElementById('compraRumFalaiseDeFleur');
var vendaRumFalaiseDeFleur = document.getElementById('vendaRumFalaiseDeFleur');
...
var compraAcucarFalaiseDeFleur = document.getElementById('compraAcucarFalaiseDeFleur');
var vendaAcucarFalaiseDeFleur = document.getElementById('vendaAcucarFalaiseDeFleur');

var compraTabacoFalaiseDeFleur = document.getElementById('compraTabacoFalaiseDeFleur');
var vendaTabacoFalaiseDeFleur = document.getElementById('vendaTabacoFalaiseDeFleur');

var compraTrigoFalaiseDeFleur = document.getElementById('compraTrigoFalaiseDeFleur');
var vendaTrigoFalaiseDeFleur = document.getElementById('vendaTrigoFalaiseDeFleur');

var compraVinhoFalaiseDeFleur = document.getElementById('compraVinhoFalaiseDeFleur');
var vendaVinhoFalaiseDeFleur = document.getElementById('vendaVinhoFalaiseDeFleur');

////IslaMuelle:

var compraCervejaIslaMuelle = document.getElementById('compraCervejaIslaMuelle');
var vendaCervejaIslaMuelle = document.getElementById('vendaCervejaIslaMuelle');

var compraChocolateIslaMuelle = document.getElementById('compraChocolateIslaMuelle');
var vendaChocolateIslaMuelle = document.getElementById('vendaChocolateIslaMuelle');

var compraCanelaIslaMuelle = document.getElementById('compraCanelaIslaMuelle');
var vendaCanelaIslaMuelle = document.getElementById('vendaCanelaIslaMuelle');

var compraRoupasIslaMuelle = document.getElementById('compraRoupasIslaMuelle');
var vendaRoupasIslaMuelle = document.getElementById('vendaRoupasIslaMuelle');

var compraCafeIslaMuelle = document.getElementById('compraCafeIslaMuelle');
var vendaCafeIslaMuelle = document.getElementById('vendaCafeIslaMuelle');

var compraAlgodaoIslaMuelle = document.getElementById('compraAlgodaoIslaMuelle');
var vendaAlgodaoIslaMuelle = document.getElementById('vendaAlgodaoIslaMuelle');

var compraEbanoIslaMuelle = document.getElementById('compraEbanoIslaMuelle');
var vendaEbanoIslaMuelle = document.getElementById('vendaEbanoIslaMuelle');

var compraFrutasIslaMuelle = document.getElementById('compraFrutasIslaMuelle');
var vendaFrutasIslaMuelle = document.getElementById('vendaFrutasIslaMuelle');

var compraCouroIslaMuelle = document.getElementById('compraCouroIslaMuelle');
var vendaCouroIslaMuelle = document.getElementById('vendaCouroIslaMuelle');

var compraLinhoIslaMuelle = document.getElementById('compraLinhoIslaMuelle');
var vendaLinhoIslaMuelle = document.getElementById('vendaLinhoIslaMuelle');

var compraMognoIslaMuelle = document.getElementById('compraMognoIslaMuelle');
var vendaMognoIslaMuelle = document.getElementById('vendaMognoIslaMuelle');

var compraOleoIslaMuelle = document.getElementById('compraOleoIslaMuelle');
var vendaOleoIslaMuelle = document.getElementById('vendaOleoIslaMuelle');

var compraPapricaIslaMuelle = document.getElementById('compraPapricaIslaMuelle');
var vendaPapricaIslaMuelle = document.getElementById('vendaPapricaIslaMuelle');

var compraTabuasIslaMuelle = document.getElementById('compraTabuasIslaMuelle');
var vendaTabuasIslaMuelle = document.getElementById('vendaTabuasIslaMuelle');

var compraRumIslaMuelle = document.getElementById('compraRumIslaMuelle');
var vendaRumIslaMuelle = document.getElementById('vendaRumIslaMuelle');
...
var compraAcucarIslaMuelle = document.getElementById('compraAcucarIslaMuelle');
var vendaAcucarIslaMuelle = document.getElementById('vendaAcucarIslaMuelle');

var compraTabacoIslaMuelle = document.getElementById('compraTabacoIslaMuelle');
var vendaTabacoIslaMuelle = document.getElementById('vendaTabacoIslaMuelle');

var compraTrigoIslaMuelle = document.getElementById('compraTrigoIslaMuelle');
var vendaTrigoIslaMuelle = document.getElementById('vendaTrigoIslaMuelle');

var compraVinhoIslaMuelle = document.getElementById('compraVinhoIslaMuelle');
var vendaVinhoIslaMuelle = document.getElementById('vendaVinhoIslaMuelle');

////Oxbay:

var compraCervejaOxbay = document.getElementById('compraCervejaOxbay');
var vendaCervejaOxbay = document.getElementById('vendaCervejaOxbay');

var compraChocolateOxbay = document.getElementById('compraChocolateOxbay');
var vendaChocolateOxbay = document.getElementById('vendaChocolateOxbay');

var compraCanelaOxbay = document.getElementById('compraCanelaOxbay');
var vendaCanelaOxbay = document.getElementById('vendaCanelaOxbay');

var compraRoupasOxbay = document.getElementById('compraRoupasOxbay');
var vendaRoupasOxbay = document.getElementById('vendaRoupasOxbay');

var compraCafeOxbay = document.getElementById('compraCafeOxbay');
var vendaCafeOxbay = document.getElementById('vendaCafeOxbay');

var compraAlgodaoOxbay = document.getElementById('compraAlgodaoOxbay');
var vendaAlgodaoOxbay = document.getElementById('vendaAlgodaoOxbay');

var compraEbanoOxbay = document.getElementById('compraEbanoOxbay');
var vendaEbanoOxbay = document.getElementById('vendaEbanoOxbay');

var compraFrutasOxbay = document.getElementById('compraFrutasOxbay');
var vendaFrutasOxbay = document.getElementById('vendaFrutasOxbay');

var compraCouroOxbay = document.getElementById('compraCouroOxbay');
var vendaCouroOxbay = document.getElementById('vendaCouroOxbay');

var compraLinhoOxbay = document.getElementById('compraLinhoOxbay');
var vendaLinhoOxbay = document.getElementById('vendaLinhoOxbay');

var compraMognoOxbay = document.getElementById('compraMognoOxbay');
var vendaMognoOxbay = document.getElementById('vendaMognoOxbay');

var compraOleoOxbay = document.getElementById('compraOleoOxbay');
var vendaOleoOxbay = document.getElementById('vendaOleoOxbay');

var compraPapricaOxbay = document.getElementById('compraPapricaOxbay');
var vendaPapricaOxbay = document.getElementById('vendaPapricaOxbay');

var compraTabuasOxbay = document.getElementById('compraTabuasOxbay');
var vendaTabuasOxbay = document.getElementById('vendaTabuasOxbay');

var compraRumOxbay = document.getElementById('compraRumOxbay');
var vendaRumOxbay = document.getElementById('vendaRumOxbay');
...
var compraAcucarOxbay = document.getElementById('compraAcucarOxbay');
var vendaAcucarOxbay = document.getElementById('vendaAcucarOxbay');

var compraTabacoOxbay = document.getElementById('compraTabacoOxbay');
var vendaTabacoOxbay = document.getElementById('vendaTabacoOxbay');

var compraTrigoOxbay = document.getElementById('compraTrigoOxbay');
var vendaTrigoOxbay = document.getElementById('vendaTrigoOxbay');

var compraVinhoOxbay = document.getElementById('compraVinhoOxbay');
var vendaVinhoOxbay = document.getElementById('vendaVinhoOxbay');

////Redmond:

var compraCervejaRedmond = document.getElementById('compraCervejaRedmond');
var vendaCervejaRedmond = document.getElementById('vendaCervejaRedmond');

var compraChocolateRedmond = document.getElementById('compraChocolateRedmond');
var vendaChocolateRedmond = document.getElementById('vendaChocolateRedmond');

var compraCanelaRedmond = document.getElementById('compraCanelaRedmond');
var vendaCanelaRedmond = document.getElementById('vendaCanelaRedmond');

var compraRoupasRedmond = document.getElementById('compraRoupasRedmond');
var vendaRoupasRedmond = document.getElementById('vendaRoupasRedmond');

var compraCafeRedmond = document.getElementById('compraCafeRedmond');
var vendaCafeRedmond = document.getElementById('vendaCafeRedmond');

var compraAlgodaoRedmond = document.getElementById('compraAlgodaoRedmond');
var vendaAlgodaoRedmond = document.getElementById('vendaAlgodaoRedmond');

var compraEbanoRedmond = document.getElementById('compraEbanoRedmond');
var vendaEbanoRedmond = document.getElementById('vendaEbanoRedmond');

var compraFrutasRedmond = document.getElementById('compraFrutasRedmond');
var vendaFrutasRedmond = document.getElementById('vendaFrutasRedmond');

var compraCouroRedmond = document.getElementById('compraCouroRedmond');
var vendaCouroRedmond = document.getElementById('vendaCouroRedmond');

var compraLinhoRedmond = document.getElementById('compraLinhoRedmond');
var vendaLinhoRedmond = document.getElementById('vendaLinhoRedmond');

var compraMognoRedmond = document.getElementById('compraMognoRedmond');
var vendaMognoRedmond = document.getElementById('vendaMognoRedmond');

var compraOleoRedmond = document.getElementById('compraOleoRedmond');
var vendaOleoRedmond = document.getElementById('vendaOleoRedmond');

var compraPapricaRedmond = document.getElementById('compraPapricaRedmond');
var vendaPapricaRedmond = document.getElementById('vendaPapricaRedmond');

var compraTabuasRedmond = document.getElementById('compraTabuasRedmond');
var vendaTabuasRedmond = document.getElementById('vendaTabuasRedmond');

var compraRumRedmond = document.getElementById('compraRumRedmond');
var vendaRumRedmond = document.getElementById('vendaRumRedmond');
...
var compraAcucarRedmond = document.getElementById('compraAcucarRedmond');
var vendaAcucarRedmond = document.getElementById('vendaAcucarRedmond');

var compraTabacoRedmond = document.getElementById('compraTabacoRedmond');
var vendaTabacoRedmond = document.getElementById('vendaTabacoRedmond');

var compraTrigoRedmond = document.getElementById('compraTrigoRedmond');
var vendaTrigoRedmond = document.getElementById('vendaTrigoRedmond');

var compraVinhoRedmond = document.getElementById('compraVinhoRedmond');
var vendaVinhoRedmond = document.getElementById('vendaVinhoRedmond');
...
function pesquisar(entradaCidadeOrigemValor, entradaCidadeDestinoValor)
{

    //DEFININDO O OBJETO DO 1º ARGUMENTO:

    if (entradaCidadeOrigemValor == "conceicao")
    {
        cidadeOrigem = conceicao;

    } else if (entradaCidadeOrigemValor == "douwesen")
    {
        cidadeOrigem = douwesen;

    } else if (entradaCidadeOrigemValor == "falaiseDeFleur")
    {
        cidadeOrigem = falaiseDeFleur;

    } else if (entradaCidadeOrigemValor == "islaMuelle")
    {
        cidadeOrigem = islaMuelle;

    } else if (entradaCidadeOrigemValor == "oxbay")
    {
        cidadeOrigem = oxbay;

    } else if (entradaCidadeOrigemValor == "redmond")
    {
        cidadeOrigem = redmond;
    ...
    //DEFININDO O OBJETO DO 2º ARGUMENTO:

    if (entradaCidadeDestinoValor == "conceicao")
    {
        cidadeDestino = conceicao;

    } else if (entradaCidadeDestinoValor == "douwesen")
    {
        cidadeDestino = douwesen;

    } else if (entradaCidadeDestinoValor == "falaiseDeFleur")
    {
        cidadeDestino = falaiseDeFleur;

    } else if (entradaCidadeDestinoValor == "islaMuelle")
    {
        cidadeDestino = islaMuelle;

    } else if (entradaCidadeDestinoValor == "oxbay")
    {
        cidadeDestino = oxbay;

    } else if (entradaCidadeDestinoValor == "redmond")
    {
        cidadeDestino = redmond;
...
function apagarEntrada1()
{
    entradaCidadeOrigem.value = "";
}

//

function apagarEntrada2()
{
    entradaCidadeDestino.value = "";
}

function apagarEntrada3()
{
...
function atualizarArgumentos()
{
    entradaCidadeOrigemValor = entradaCidadeOrigem.value;
    entradaCidadeDestinoValor = entradaCidadeDestino.value;
    entradaProdutoValor = entradaProduto.value;
}
